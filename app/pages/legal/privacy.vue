...
<template>
  ...
  <section id="hosting">
    ...
    <p><b>Wir setzen folgende(n) Hoster ein:</b></p>
    ...
    <p>
      ...
      der Dienstleistungen der <b>netcup GmbH</b> geschlossen. Hierbei handelt
    ...
    <br />
    <h3>Speicherung von Mediendateien (Cloudflare R2)</h3>
    <p>
      Alle Dateien (Bilder und ggf. Videos) der Website werden bei
      <b>Cloudflare R2</b> gespeichert und von dort ausgeliefert. Cloudflare R2
      ist ein Objektspeicher-Dienst der <b>Cloudflare, Inc.</b>
      <br />
    </p>
    <p>
      101 Townsend St.<br />
    ...
    <br />
    <p>
      Die Speicherung dient der
      <b>schnellen und effizienten Bereitstellung</b> der Mediendateien (Art. 6
      Abs. 1 lit. f DSGVO).
    </p>
    <br />

    <p>
      Da dieser Dienst von einem US-amerikanischen Unternehmen betrieben wird,
      kann eine Daten&uuml;bermittlung in die USA erfolgen. Cloudflare hat sich
      dem <b>EU-US Data Privacy Framework (DPF)</b> angeschlossen, wodurch die
      Rechtm&auml;&szlig;igkeit der Daten&uuml;bermittlung nach Art. 45 DSGVO
      gew&auml;hrleistet wird.
    </p>
    <br />
  </section>
  ...
  <section id="allgemeine-hinweise-und-pflichtinformationen">
    ...
    <p>
      Turboman3000 - Leon-David Rambow<br />
      c/o Online-Impressum.de #4889<br />
      Europaring 90<br />
      53757 Sankt Augustin
    </p>

    <p>E-Mail: info@chaos-familie.de</p>
    <br />
    ...
    <UAccordion
      ...
      :items="[
        {
          label: 'Ihr Recht bei Bestreitung der Richtigkeit Ihrer Daten',
          content:
        ...
        {
          label:
            'Ihr Recht auf Einschränkung der Verarbeitung bei Unrechtmäßigkeit',
          content:
        ...
        {
          label:
            'Einschränkung der Verarbeitung zur Geltendmachung von Rechtsansprüchen',
          content:
        ...
        {
          label:
            'Einschränkung der Verarbeitung während der Prüfung eines Widerspruchs',
          content:
  ...
  <section id="datenerfassung-auf-dieser-website">
    ...
    <p>
      ...
      Anbieter ist die <b>Google Ireland Limited („Google“)</b>.
    </p>
    <p>
      Gordon House <br />
      Barrow Street<br />
    ...
    <p>
      Google Analytics ermöglicht dem Websitebetreiber, das Verhalten der
      Websitebesucher zu analysieren. Hierzu erhält der Websitebetreiber
      verschiedene Nutzungsdaten, wie z. B. aufgerufene Seiten, Verweildauer,
      verwendete Betriebssysteme und die Herkunft des Nutzers. Diese Daten
      werden in einer pseudonymisierten Nutzer-ID zusammengefasst und dem
      jeweiligen Endgerät des Websitebesuchers zugeordnet.
    </p>
    <br />

    <p>
      Des Weiteren kann Google Analytics mithilfe der im Zusammenhang mit dieser
      Analyse erfassten Daten verschiedene Sitzungs-, Such- und
      Transaktionsströme zu einer einzigen Zielgruppe zusammenführen.
    </p>
    <br />

    <p>
      Der Einsatz von Google Analytics erfolgt auf Grundlage Ihrer Einwilligung
      gem. Art. 6 Abs. 1 lit. a DSGVO und § 25 Abs. 1 TDDDG. Die Einwilligung
    ...
    <p>
      ...
      <a
        class="link"
        href="https://business.safety.google/adscontrollerterms/sccs/c2c/"
        target="_blank"
        rel="noopener noreferrer"
        >https://business.safety.google/adscontrollerterms/sccs/c2c/</a
      >.
    </p>
    <br />

    <p>
      <b>IP-Anonymisierung</b> Wir haben auf dieser Website die Funktion
      ...
      der Übermittlung in die USA gekürzt. Nur in Ausnahmefällen wird die volle
      ...
      Analytics von Ihrem Browser übermittelte IP-Adresse wird laut Google nicht
      mit anderen Daten von Google zusammengeführt.
    </p>
    <br />

    <p>
      <b>Auftragsverarbeitung</b>> Wir haben mit Google einen Vertrag zur
  ...
  <section id="soziale-medien">
    ...
    <p>
      ...
      Funktion &bdquo;Re-Tweet&ldquo; bzw. &bdquo;Repost&ldquo; werden die von
      Ihnen besuchten Websites mit Ihrem X (ehemals Twitter)-Account
      verkn&uuml;pft und anderen Nutzern bekannt gegeben. Wir weisen darauf hin,
    ...
    <p>
      ...
      <a
        ...
        rel="noopener noreferrer"
        class="link"
        >https://gdpr.x.com/en/controller-to-controller-transfers.html</a
      >.
    </p>
    <br />
    <p>
      Ihre Datenschutzeinstellungen bei X (ehemals Twitter) k&ouml;nnen Sie in
      ...
      <a
        ...
        rel="noopener noreferrer"
        class="link"
        >https://x.com/settings/account</a
      >
      &auml;ndern.
    </p>
    <br />
    ...
    <p>
      ...
      folgendem Link:
      <a
        href="https://www.dataprivacyframework.gov/participant/2710"
        target="_blank"
        rel="noopener noreferrer"
        class="link"
        >https://www.dataprivacyframework.gov/participant/2710</a
      >.
    </p>
    <br />
  ...
  <section id="plugins-und-tools">
    ...
    <p>
      ...
      ist die Google Ireland Limited (&bdquo;Google&rdquo;), Gordon House,
      Barrow Street, Dublin 4, Irland.
    </p>
    <br />
    <p>
      Wenn Sie eine dieser Website besuchen, auf denen YouTube eingebunden ist,
      wird eine Verbindung zu den Servern von YouTube hergestellt. Dabei wird
    ...
    <p>
      ...
      keine Cookies gesetzt. Stattdessen werden jedoch sogenannte Local Storage
      Elemente im Browser des Users gespeichert, die &auml;hnlich wie Cookies
      personenbezogene Daten beinhalten und zur Wiedererkennung eingesetzt
      werden k&ouml;nnen. Details zum erweiterten Datenschutzmodus finden Sie
      hier:
      <a
    ...
    <p>
      ...
      weitere Datenverarbeitungsvorg&auml;nge ausgel&ouml;st werden, auf die wir
    ...
    <p>
      ...
      Schweden. Die Spotify Plugins erkennen Sie an dem gr&uuml;nen Logo auf
      dieser Website. Eine &Uuml;bersicht &uuml;ber die Spotify-Plugins finden
      Sie unter:
      <a
    ...
    <br />
    <p>
      Dadurch kann beim Besuch dieser Website &uuml;ber das Plugin eine direkte
      Verbindung zwischen Ihrem Browser und dem Spotify-Server hergestellt
      werden. Spotify erh&auml;lt dadurch die Information, dass Sie mit Ihrer
      IP-Adresse diese Website besucht haben. Wenn Sie den Spotify Button
      anklicken, w&auml;hrend Sie in Ihrem Spotify-Account eingeloggt sind,
      k&ouml;nnen Sie die Inhalte dieser Website auf Ihrem Spotify Profil
    ...
    <p>
      ...
      Spotify auch an Google weitergegeben werden k&ouml;nnen. Google Analytics
      ist ein Tool des Google-Konzerns zur Analyse des Nutzerverhaltens mit Sitz
      in den USA. F&uuml;r diese Einbindung ist allein Spotify verantwortlich.
      Wir als Websitebetreiber haben auf diese Verarbeitung keinen Einfluss.
    </p>
    <br />
    <p>
      ...
      an der ansprechenden akustischen Ausgestaltung seiner Website. Sofern eine
      entsprechende Einwilligung abgefragt wurde, erfolgt die Verarbeitung
      ausschlie&szlig;lich auf Grundlage von Art. 6 Abs. 1 lit. a DSGVO und
      &sect; 25 Abs. 1 TDDDG, soweit die Einwilligung die Speicherung von
      Cookies oder den Zugriff auf Informationen im Endger&auml;t des Nutzers
